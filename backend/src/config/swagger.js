/**
 * CONFIGURAÇÃO CENTRALIZADA DO SWAGGER (DOCUMENTAÇÃO DA API)
 * 
 * 💡 Explicação para iniciantes:
 * O Swagger (OpenAPI 3.0) é uma especificação padrão de mercado para documentar APIs REST.
 * Em vez de criar um arquivo YAML complexo ou espalhar comentários bagunçados por vários arquivos,
 * criamos esta estrutura JavaScript simples e centralizada que o Swagger UI usa para gerar
 * uma página web interativa em `http://localhost:3000/docs`.
 */
  ...
  paths: {
    ...
    "/auth/login": {
      post: {
        ...
        description: "Autentica um usuário cadastrado comparando email e senha.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
